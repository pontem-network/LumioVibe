...
export enum I18nKey {
  ...
  EXIT_APP$CONFIRM = "EXIT_APP$CONFIRM",
  EXIT_APP$TITLE = "EXIT_APP$TITLE",
  ...
  LOADING_APP$LOADING = "LOADING_APP$LOADING",
  ...
  APP_MENU_DETAILS_PLACEHOLDER$NEW_APP_LABEL = "APP_MENU_DETAILS_PLACEHOLDER$NEW_APP_LABEL",
  APP_MENU_DETAILS_PLACEHOLDER$CONNECT_TO_GITHUB = "APP_MENU_DETAILS_PLACEHOLDER$CONNECT_TO_GITHUB",
  APP_MENU_DETAILS_PLACEHOLDER$CONNECTED = "APP_MENU_DETAILS_PLACEHOLDER$CONNECTED",
  APP_MENU_DETAILS$AGO_LABEL = "APP_MENU_DETAILS$AGO_LABEL",
  ...
  APP_MENU_CARD_CONTEXT_MENU$CONNECT_TO_GITHUB_LABEL = "APP_MENU_CARD_CONTEXT_MENU$CONNECT_TO_GITHUB_LABEL",
  APP_MENU_CARD_CONTEXT_MENU$PUSH_TO_GITHUB_LABEL = "APP_MENU_CARD_CONTEXT_MENU$PUSH_TO_GITHUB_LABEL",
  APP_MENU_CARD_CONTEXT_MENU$DOWNLOAD_FILES_LABEL = "APP_MENU_CARD_CONTEXT_MENU$DOWNLOAD_FILES_LABEL",
  APP_MENU_CARD$OPEN = "APP_MENU_CARD$OPEN",
  ...
  EXIT_APP$WARNING = "EXIT_APP$WARNING",
  ...
  COMMON$RECENT_APPS = "COMMON$RECENT_APPS",
  ...
  HOME$NEW_APP_DESCRIPTION = "HOME$NEW_APP_DESCRIPTION",
  ...
  LUMIO_MODE_TOGGLES$testing = "LUMIO_MODE_TOGGLES$testing",
  AI_CHAT$TITLE = "AI_CHAT$TITLE",
  AI_CHAT$SUBTITLE = "AI_CHAT$SUBTITLE",
  AI_CHAT$HIDE_TEMPLATE = "AI_CHAT$HIDE_TEMPLATE",
  AI_CHAT$SHOW_TEMPLATE = "AI_CHAT$SHOW_TEMPLATE",
}
