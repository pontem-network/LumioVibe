  ...
  return (
    <a
      ...
      className={cn(
        ...
        hasBranch
          ? "border border-[#3a3a3a] bg-transparent hover:border-[#AE7993] cursor-pointer transition-colors duration-300"
          : "border border-[#2a2a2a] bg-transparent cursor-not-allowed min-w-[108px]",
      )}
    >
