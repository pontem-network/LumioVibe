        ...
        <>
          ...
          <label className="flex flex-col gap-2.5 w-full max-w-[680px]">
            ...
            <textarea
              ...
              placeholder="arg1&#10;arg2&#10;arg3"
              className={cn(
                "bg-[#141414] border border-[#2a2a2a] w-full rounded-lg p-2.5 placeholder:italic placeholder:text-[rgba(255,255,255,0.3)] resize-none transition-all duration-300 focus:border-[#AE7993] focus:outline-none",
          ...
          <label className="flex flex-col gap-2.5 w-full max-w-[680px]">
            ...
            <textarea
              ...
              className={cn(
                "resize-none",
                "bg-[#141414] border border-[#2a2a2a] rounded-lg p-2.5 placeholder:italic placeholder:text-[rgba(255,255,255,0.3)] transition-all duration-300 focus:border-[#AE7993] focus:outline-none",
                "disabled:bg-[#1a1a1a] disabled:border-[#1a1a1a] disabled:cursor-not-allowed",
              )}
            />
          </label>
