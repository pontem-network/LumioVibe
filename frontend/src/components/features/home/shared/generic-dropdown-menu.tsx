...
export function GenericDropdownMenu<T>({
  ...
  return (
    <div className="relative">
      <div
        className={cn(
          "absolute z-10 w-full bg-[#0a0a0a] border border-[#2a2a2a] rounded-lg shadow-lg backdrop-blur-sm",
      ...
      >
                ...
                <>
                  ...
                  {numberOfRecentItems > 0 &&
                    index === numberOfRecentItems - 1 && (
                      <div className="border-b border-[#2a2a2a] bg-[#0a0a0a] pb-1 mb-1 h-[1px]" />
                    )}
                </>
              ))}
            </>
        ...
        {stickyFooterItem && (
          <div className="border-t border-[#2a2a2a] bg-[#0a0a0a] p-1 rounded-b-lg">
            {stickyFooterItem}
          </div>
        )}
      </div>
