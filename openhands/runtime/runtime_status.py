...
class RuntimeStatus(Enum):
    ...
    INITIALIZING_TEMPLATE = 'STATUS$INITIALIZING_TEMPLATE'
    TEMPLATE_INITIALIZED = 'STATUS$TEMPLATE_INITIALIZED'
    ERROR_TEMPLATE_INIT = 'STATUS$ERROR_TEMPLATE_INIT'
    ERROR_TEMPLATE_START = 'STATUS$ERROR_TEMPLATE_START'
