...
class AgentController:
    ...
    def __init__(
        ...
        self.state = self.state_tracker.state  # TODO: share between manager and controller for backward compatibility; we should ideally move all state related logic to the state manager
