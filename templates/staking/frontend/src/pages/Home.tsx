    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <p className="text-lg text-white/50 max-w-md mb-8">
          Connect your wallet to interact with the staking pool contract on Lumio Network
        </p>
        <div className="flex items-center gap-4">
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-white/50">
          Stake tokens and earn rewards with this DeFi staking pool
        </p>
      </div>
      ...
      {!initialized ? (
        <div className="glass-card p-12 text-center">
          ...
          <h2 className="text-2xl font-bold mb-3">Initialize Staking Pool</h2>
          <p className="text-white/50 mb-8 max-w-sm mx-auto">
            Create a staking pool on the blockchain to start tracking your value
          </p>
        ...
        <>
          <div className="glass-card p-12 text-center">
            ...
            <div className="flex items-center justify-center gap-4">
              <ActionButton onClick={handleStake} loading={loading}>
                <span className="inline-flex items-center gap-2">
      ...
      <div className="glass-card p-6">
        ...
        <div className="space-y-0">
          ...
          <div className="info-row">
            ...
            <span className="info-value font-mono">staking::staking</span>
          </div>
          <div className="info-row">
